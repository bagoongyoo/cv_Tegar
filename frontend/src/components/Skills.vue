...
<template>
  <section id="skill" class="py-20 bg-slate-500">
    <div class="container mx-auto px-6">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div
          ...
          :key="skill.name"
          class="bg-gray-100 p-6 rounded-lg shadow-lg text-center transform hover:-translate-y-2 transition-transform duration-300"
        >
